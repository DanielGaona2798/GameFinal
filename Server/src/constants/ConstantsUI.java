...
public class ConstantsUI {
	...
	public static final String PATH_FILE = "src/persistence/file.json";
	public static final Dimension DIMENSION = new Dimension(400, 700);
	public static final String LIST_TITLE = "COnected List";
